...
importScripts("presets/starsTournament.js")
importScripts("ecc-edc-recalc-js/index.js")
importScripts("customFloor/pack.js")
importScripts("customPalettes/recolor.js")
...
self.addEventListener('message', function(message) {
  try {
    ...
    if (!!message.data.customPalettes) {
      adRando.recolor.recolorSprites(array, message.data.customPalettes)
    }
